...
Documentación técnica del pipeline de datos: entorno, comandos, estructura de
carpetas y las decisiones no obvias sobre los datos. Para la presentación del
proyecto, ver el [README principal](../README.md).
...
análisis. El detalle de cada columna está en [`limpieza.md`](limpieza.md).
...
están en [`diccionario_de_datos.md`](diccionario_de_datos.md), que
